...
/* ═══════════════════════════════════════════════════════════
   ANABLE  —  Enabling your travel experiences
   ...
   iOS:  Add a Share Extension target (Swift) to the Expo/RN app.
         ...
         via NSExtensionItem, deep-links into the main app:
           anable://save?url=https://www.instagram.com/p/XXX
   ...
   Web fallback (this demo): user pastes the URL manually.
   The demo simulates the full metadata-fetch pipeline.
═══════════════════════════════════════════════════════════ */
...
// Simulates what the backend metadata pipeline returns from an Instagram URL
const MOCK_METADATA = [
  { location:"Shibuya, Tokyo, Japan",        caption:"🌃 Omoide Yokocho (Memory Lane) in Shibuya — tiny yakitori stalls, sake, smoky grills at 1am. Pure uncut Tokyo. #Tokyo #Yakitori #LateNight",            thumb:"https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?w=600&h=400&fit=crop", username:"@nocturnal.food",   likes:34200 },
  { location:"Ubud, Bali, Indonesia",         caption:"Sacred Monkey Forest Sanctuary, Ubud — 700 monkeys and ancient temples 🌿🐒 Go at 8:30am before the tour buses. Don't bring any food. #Bali",                thumb:"https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=600&h=400&fit=crop", username:"@wild.dest",       likes:58900 },
  { location:"Fitzroy, Melbourne, Australia", caption:"Hosier Lane street art — one of Melbourne's most vibrant living galleries 🎨 Changes weekly. Then walk to Hardware Lane for lunch. #Melbourne #StreetArt", thumb:"https://images.unsplash.com/photo-1514395462725-fb4566210144?w=600&h=400&fit=crop", username:"@wallsofmelb",     likes:21600 },
  { location:"Gion, Kyoto, Japan",            caption:"Nishiki Tenmangu Shrine hidden inside Nishiki Market — most tourists walk right past it 🏮 Stop for a fortune slip. #Kyoto #HiddenGem",                    thumb:"https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&h=400&fit=crop", username:"@kansai.secrets",  likes:17400 },
  { location:"Canggu, Bali, Indonesia",       caption:"Tanah Lot sea temple at high tide 🌊⛩️ Get there 30 min before sunset for the perfect silhouette photo. Watch out for the holy snake! #Bali",             thumb:"https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=600&h=400&fit=crop", username:"@bali.at.dusk",    likes:93200 },
];
...
export default function Anable() {
  ...
  const handlePaste = async () => {
    ...
    const meta = MOCK_METADATA[Math.floor(Math.random() * MOCK_METADATA.length)];
      ...
      {shareModal&&(
        <div style={{position:"fixed",inset:0,zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
          ...
          <div style={{position:"relative",background:"#10101E",border:"1px solid rgba(255,255,255,.1)",borderRadius:28,padding:"34px 30px",maxWidth:460,width:"100%",boxShadow:"0 40px 80px rgba(0,0,0,.6)",animation:"fadeUp .3s ease"}}>
            ...
            <p style={{color:"#5A5448",fontSize:13,marginBottom:24,lineHeight:1.65}}>Share any travel post directly to Anable — it auto-sorts into the right destination bucket.</p>
            ...
            <div style={{background:"rgba(201,169,110,.07)",border:"1px solid rgba(201,169,110,.15)",borderRadius:16,padding:"18px 20px",marginBottom:24}}>
              ...
              <div style={{marginTop:12,padding:"10px 14px",background:"rgba(255,255,255,.04)",borderRadius:10,fontSize:11,color:"#4A4440",lineHeight:1.65}}>
                Anable appears natively in the iOS & Android share sheet — the same way you'd share to WhatsApp or Notes. No copy-pasting required on mobile.
              </div>
            </div>
        ...
        {screen==="home"&&(
          <div>
            <nav style={{padding:"18px 28px",borderBottom:"1px solid rgba(255,255,255,.05)",background:"rgba(7,7,15,.92)",backdropFilter:"blur(20px)",position:"sticky",top:0,zIndex:10,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <span style={{fontFamily:"'Cormorant Garamond',serif",fontSize:26,fontWeight:300,background:"linear-gradient(135deg,#EAE6DC,#C9A96E)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>anable</span>
            ...
            <div style={{maxWidth:1100,margin:"0 auto",padding:"44px 28px"}}>
              <div style={{marginBottom:44,animation:"fadeUp .5s ease"}}>
                ...
                <p style={{color:"#4A4440",fontSize:15,lineHeight:1.75,maxWidth:500}}>Every Instagram post you share to Anable is automatically sorted by destination — ready to star, explore, and plan from.</p>
              </div>
              ...
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:20,flexWrap:"wrap",background:"rgba(201,169,110,.06)",border:"1px dashed rgba(201,169,110,.22)",borderRadius:20,padding:"20px 24px",marginBottom:40}}>
                <div style={{display:"flex",alignItems:"center",gap:16}}>
                  ...
                  <div>
                    <div style={{fontSize:14,fontWeight:500,color:"#C9A96E",marginBottom:3}}>Share any Instagram travel post directly to Anable</div>
